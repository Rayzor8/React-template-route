    ...
    <div className="text-center p-10">
      <div className="flex justify-center items-center flex-col gap-4">
        ...
        <p className="text-justify text-sm">
          ...
          neque delectus laudantium architecto ipsum. A amet impedit enim!
          Aliquid, nisi delectus, vitae facere, ad expedita rem fugiat maxime
          tenetur ex porro explicabo iste doloribus eum. Ipsa porro ipsum
          asperiores fugit aliquam, ducimus esse ad assumenda accusantium
          molestiae repellat! Accusamus architecto adipisci cum repellendus
          totam earum voluptatem maxime, dolor perferendis laboriosam natus
          similique laudantium hic quasi eligendi iste culpa eius, libero veniam
          nam ipsa. Perferendis, voluptatem quas. Praesentium, quod? Possimus
          dolores deleniti non quo cupiditate quaerat mollitia officiis
          provident a neque similique eius omnis ducimus doloribus nisi,
          maiores, odit porro ratione architecto eligendi veniam odio?
          Voluptates doloremque cum ut!
        </p>
      </div>
